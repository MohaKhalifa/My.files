...
alias pch='git add ~/bu/LR/git/my.files/bashrc && git commit ~/bu/LR/git/my.files/bashrc -m "Coool New alias" && cd ~/bu/LR/git/my.files && git push origin main && cd -'  # I'm wasting my time fr 
